...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/weathered-sun-d3e2
```

A live public deployment of this template is available at [https://weathered-sun-d3e2.templates.workers.dev](https://weathered-sun-d3e2.templates.workers.dev)
